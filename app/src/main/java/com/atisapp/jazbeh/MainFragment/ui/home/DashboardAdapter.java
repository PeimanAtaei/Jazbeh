...
public class DashboardAdapter extends RecyclerView.Adapter<DashboardAdapter.ViewHolder>{
    ...
    public DashboardAdapter(Context context,List<ProductModel> productList,int viewType) {
        this.ctx = context;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)  {
        ...
        View view;
        view = layoutInflater.from(parent.getContext()).inflate(R.layout.layout_dashboard_category_eachitem,parent,false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder  {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            dashboard_list_each_item_box = itemView.findViewById(R.id.dashboard_category_box);
            dashboard_list_each_item_title = itemView.findViewById(R.id.dashboard_category_title);
